...
//pdf generate function
    function generatePDF(){
        ...
        doc.text(20, 20,'We Want '+ vehicleType)
        doc.addFont('helvetica', 'normal')
        doc.setFontSize(12);
        doc.setTextColor(3, 3, 3);
        doc.text(25, 40, 'Vehicle Type : '+vehicleType)
        doc.text(25, 50, 'Brand : '+brand)      
        doc.text(25, 60, 'Color : '+color)      
        doc.text(25, 70, 'Condition  : '+condition)      
        doc.text(25, 80, 'Model  : '+model)      
        doc.text(25, 90, 'Action Date : '+auctionDate)      
                                ...
                                <MDBCard className='shadow-0'>
                                    <MDBCardBody>
                                        ...
                                        <div className="text-end">
                                            ...
                                            <button type="button" class="btn btn-primary d-letter-spacing " onClick={generatePDF} >Print</button>
                                        </div>
                                    </MDBCardBody>
                                </MDBCard>
                            </MDBCol>
