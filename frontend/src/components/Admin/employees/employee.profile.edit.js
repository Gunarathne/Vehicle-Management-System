...
function EmployeeProfileEdit() {
    ...
    function generatePDF(){
        ...
        doc.text(25, 60, 'Employee Name : '+name)
        doc.text(25, 80, 'Employee Address : '+address)      
        doc.text(25, 100, 'Telephone Number : '+phone)      
        doc.text(25, 120, 'Gender : '+gender)      
        doc.text(25, 140, 'Birth Day : '+bod)      
        doc.text(25, 160, 'NIC : '+nic)      
        doc.text(25, 180, 'Salary : '+salary)      
        doc.text(25, 200, 'Position : '+position)      
